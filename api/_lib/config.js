...
function validate(env) {
  ...
  if (has('APP_BASE_URL')) {
    ...
    } else if (/\.vercel\.app|\.netlify\.app/.test(u)) {
      // ลิงก์ดาวน์โหลดในอีเมลสร้างจากค่านี้ ถ้าเป็นโดเมนของแพลตฟอร์ม
      // ลูกค้าจะกดแล้วเจอหน้าเตือน "เว็บไซต์ปลอม" ของ Chrome เพราะชื่อ
      // คล้ายโดเมนจริงจนถูกจับว่าเลียนแบบ และ sessionStorage ก็คนละโดเมน
      warnings.push('APP_BASE_URL: ยังชี้ไปโดเมนของแพลตฟอร์ม (' + u + ') ' +
                    'ควรเป็น https://vinko.quest — ลิงก์ในอีเมลทุกฉบับสร้างจากค่านี้');
    }
  }
