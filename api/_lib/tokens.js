...
/* จำนวนครั้งที่โหลดได้ต่อไฟล์
 *
 * นับตอนเริ่มส่งไฟล์ ไม่ใช่ตอนโหลดเสร็จ (เพราะฝั่ง server ไม่มีทางรู้ว่า
 * เครื่องลูกค้ารับครบหรือยัง) แปลว่าโหลดหลุดกลางคันก็โดนนับไปแล้ว
 * ไฟล์ LAB 13 MB บนเน็ตมือถือหลุดง่ายมาก 10 ครั้งจึงเสี่ยงที่ลูกค้า
 * จะถูกล็อกทั้งที่ยังไม่เคยได้ไฟล์เลยสักครั้ง
 *
 * ตัวกันของจริงคือลายน้ำระบุตัวผู้ซื้อทุกหน้า กับลิงก์ที่หมดอายุใน 48 ชม.
 * ตัวเลขนี้เป็นแค่เพดานกันเอาลิงก์ไปโพสต์ในกลุ่ม ไม่ใช่ด่านหลัก */
const MAX_DOWNLOADS_PER_ITEM = 20;
